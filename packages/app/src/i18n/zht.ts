...
export const dict = {
  ...
  "command.terminal.openGhostty": "在 Ghostty 中開啟",
  "command.terminal.openGhostty.description": "在 Ghostty 中開啟目前專案目錄",
  "command.terminal.openWezTerm": "在 WezTerm 中開啟",
  "command.terminal.openWezTerm.description": "在 WezTerm 中開啟目前專案目錄",
